...
private:
    ...
    inline const static vector<string> conjunctions = {
            "а", "благодаря", "благо", "будто", "вдобавок", "да", "дабы", "даже", "же", "едва", "ежели", "если", "затем", "зато", "зачем", "и", "ибо", "или", "кабы", "как", "когда", "коли", "либо", "ли", "лишь", "нежели", "несмотря", "невзирая", "но", "однако", "оттого", "отчего", "пока", "покамест", "покуда", "поскольку", "потому", "почему", "притом", "причем", "пускай", "пусть", "раз", "словно", "также", "тоже", "только", "точно", "хотя", "чем", "что", "чтоб", "чтобы"
    };

    // List of prepositions in russian language
    inline const static vector<string> prepositions = {
            "без", "близ", "в", "вместо", "вне", "для", "до", "за", "из", "из-за", "из-под", "к", "кроме", "между", "меж", "ко", "во", "безо", "на", "над", "надо", "о", "об", "обо", "от", "ото", "перед", "передо", "пред", "предо", "по", "под", "подо", "при", "про", "ради", "с", "со", "сквозь", "среди", "у", "через",
    };
    ...
    inline const static vector<char> softeners = {'ё', 'е', 'я', 'и', 'ь', 'ю'};
    ...
    inline const static vector<string> pronouns = {
            "я", "ты", "он", "оно", "она", "мы", "вы", "они", "меня", "тебя", "его", "ее", "нас", "вас", "их", "мне", "тебе", "ему", "ей", "нам", "вам", "им", "меня", "тебя", "его", "ее", "нас", "вас", "их", "мной", "мною", "тобой", "тобою", "им", "ей", "ею", "нами", "вами", "ими", "обо", "мне", "тебе", "нем", "ней", "нас", "вас", "них", "себя", "себе", "себя", "собой", "мой", "твой", "наш", "ваш", "свой", "мое", "твое", "наше", "ваше", "свое", "моя", "твоя", "наша", "ваша", "своя", "мои", "твои", "наши", "ваши", "свои", "моего", "твоего", "нашего", "вашего", "своего", "моей", "твоей", "нашей", "вашей", "своей", "моих", "твоих", "наших", "ваших", "своих", "моему", "твоему", "нашему", "вашему", "своему", "моим", "твоим", "нашим", "вашим", "своим", "мою", "твою", "нашу", "вашу", "свою", "моими", "твоими", "нашими", "вашими", "своими", "моем", "твоем", "нашем", "вашем", "своем"
    };
